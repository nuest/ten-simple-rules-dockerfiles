...
In that the actual contribution to knowledge includes the full computing environment that produced a result [@donoho_invitation_2010], containerisation is needed.

Containerisation plays an important role in providing instructions for packaging the building blocks of computer-based research (i.e. code, data, documentation, and the computing environment).
