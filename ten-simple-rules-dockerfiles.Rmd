...
If a pre-build image is provided on Docker Hub, you should direct the user to it.
...
It's likely going to be the case that you develop workflows that are similar in nature.
...
Reproducibility in research is an endeavour of best efforts, not about achieving the perfect solution, as that is probably not achievable or even changing over time.
