...
\begin{lstlisting}[language=docker,caption={Partial \texttt{Dockerfile} with commonly used labels; note the whitespace-preserving line breaks within the values, which were added for readability here but in practice would likely be longer lines.},breaklines=true,label={lst:labels}]
...
