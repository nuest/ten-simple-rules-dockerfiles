...
A linter can help you with such optimizations, e.g., [Dockerfilelint](https://www.dockerfilelint.com/) or [hadolint](https://hadolint.github.io/hadolint/) in the browser, extension to your integrated development environment, such as [vscode-docker](https://github.com/microsoft/vscode-docker), or standalone tools like [`dockerfile-lint`](https://github.com/projectatomic/dockerfile_lint), which you can integrate in your `Makefile`.
