...
If you want to add local files to the container, we prefer `COPY` because it is explicit and you do not need `ADD`'s extra features (see the documentation for details: https://docs.docker.com/engine/reference/builder/).
