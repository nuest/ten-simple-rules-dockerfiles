...
docker run --mount type=bind,src=$HOME/project,dst=/project,readonly mycontainer

# mount multple directories, one with write access relative to current path (Linux)
docker run --mount type=bind,src=$HOME/article-x-supplement/data,dst=/data,readonly \
