...
If you are using a container built by a `Dockerfile` regularly in your work, it's recommended to set up continuous deployment, or a strategy to ensure that the container is regularly built and tested.
...
Finally, for a sanity check it can be helpful to ask a colleague to interact with your workflow or container on a machine of their own.
