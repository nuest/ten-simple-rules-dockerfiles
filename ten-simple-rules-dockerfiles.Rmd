...
# $ docker run -e ITERATIONS=10 -e ALGORITHM=advanced --volume /tmp/results:/workspace/output_data workflow-runner:1.0
```

\normalsize

_Listing 2_: Workflow `Dockerfile` and derived "runner image" `Dockerfile` with filename `Dockerfile.runner`
