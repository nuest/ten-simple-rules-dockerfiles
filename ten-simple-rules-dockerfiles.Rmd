...
To support advanced custom configuration, it's helpful to expose settings via a configuration file, which can be bind mounted from the host [cf. @verstegen_pluc_mozambique_2019], via environment variables [cf. @knoth_reproducibility_2017], or via wrappers using Docker, such as Kliko [@molenaar_klikoscientific_2018].
