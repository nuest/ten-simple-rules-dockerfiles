...
In any case you should document different variants ver well, potentially capture build and run commans a `Makefile` [@wikipedia_contributors_make_2019].
...
_Listing 4_: Workflow `Dockerfile` and derived "runner image" `Dockerfile` with filename `Dockerfile.runner`. \newline
