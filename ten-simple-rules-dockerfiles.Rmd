...
Within such a compendium, it is suggested to include instructions, i.e. a human- and machine-readable recipe, for buiding containers that capture the computing environment, i.e., all software and data dependencies.
