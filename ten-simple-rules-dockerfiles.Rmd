...
The consistency added by linting also helps keeping your edits to a Dockerfile under version control meaningful.
...
If the container is linked to an automated build provided by a version control service, simply pushing the `Dockerfile` to the service can easily trigger the build and ideally a simple validating execution.
