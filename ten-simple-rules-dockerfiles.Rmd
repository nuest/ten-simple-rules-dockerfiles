...
Containers can be modified, stopped, restarted and purged. A visual analogy with a compiled programming language is given in Figure&nbsp;1 for the workflow used to specify and build running Docker containers. 
