...
Clarity of the steps within a Dockerfile is most important, and if it requires verbosity or adds to the final image size, that is an acceptable tradeoff.
...
```bash
git clone -b v3.6.1 https://github.com/hpcng/singularity
```
