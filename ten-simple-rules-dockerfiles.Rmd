...
# command unchanged for devlopment, uncomment the following line to have a "run workflow only" container
# CMD["./myscript.sh"]

# Usage:
# docker build --tag ten-simple-example:1.0.0 .
# docker run -p 8787:8787 ten-simple-example:1.0.0
```

_Listing&nbsp;1: `Dockerfile` full example.
