...
\texttt{Dockerfile} is a machine- and human-readable recipe, comparable
to a \texttt{Makefile} {[}27{]}, for building \textbf{images}. Here,
images are executable files that include the application, e.g., the
...
can be cached across image builds for minimising build and download
times. Once an image is built or downloaded, it is then launched as a
running instance known as a \textbf{container}. The images have a main
