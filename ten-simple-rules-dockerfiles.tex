...
restarted and purged. A visual analogy with a compiled programming
language is given in Figure~1 for the workflow used to specify and build
running Docker containers. \texttt{Dockerfile}s, like Makefiles
{[}26{]}, are meant to be useful for both humans to read and for
computers to execute. See Listing~1 for a full \texttt{Dockerfile},
